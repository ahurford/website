...
You can submit your documents for consideration [here](https://docs.google.com/forms/d/e/1FAIpQLSfUZB3AStdgHA6kL-SBR08IMVv2z8G3bdRVegrhLsqxWDkKEA/viewform?usp=sf_link). I will review submitted applications beginning in November of each year for admissions in the following September. In fairness to all interested, I do not take graduate applications without advertising, however, all positions remain open until filled. On some occasions positions can be unfilled after an October search. Please email me if you have submitted your documents independently of the advertisements so I can review your submission.
...
- George Adu-Boahen (MSc in Mathematics, 2025). Optimal control strategies in epidemic models: analysis of community and traveler isolation strategies under resource constraints.
